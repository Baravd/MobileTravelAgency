...
public class CustomerMyItemsAdapter extends ArrayAdapter<Item> {
    private  Context context;


    public CustomerMyItemsAdapter(@NonNull Context context, int resource, @NonNull List<Item> objects) {
